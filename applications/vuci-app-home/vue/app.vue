<template>
  <div>
    <div style="position: relative; top: 70px">
      <vuci-line :length="lineLength" :style="{ position: 'absolute', left: lineOffset }" active/>
      <vuci-line :length="lineLength" :style="{ position: 'absolute', right: lineOffset }" active :disconnect="!wanIsUp"/>
    </div>
    <div class="vuci-home-tabs">
      <div>
      ...
      <div style="clear: both">
        ...
        <div v-show="tab === 'router'">
          <div style="display: flex; justify-content: space-around;">
            <vuci-dashboard :percent="cpuPercentage" :label="$t('home.CPU usage')"/>
            <vuci-dashboard :percent="memPercentage" :label="$t('home.Memory usage')"/>
            <vuci-dashboard :percent="storagePercentage" :label="$t('home.Storage')"/>
          </div>
