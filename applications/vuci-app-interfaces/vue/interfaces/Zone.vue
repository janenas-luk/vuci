<template>
  <vuci-form-item-select :uci-section="uciSection" :label="$t('interfaces.Create / Assign firewall-zone')" name="_fwzone" :options="zones" :load="loadZone" :save="saveZone" allow-create :help="$t('interface-config-zone-desc')"/>
</template>
